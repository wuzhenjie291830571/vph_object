...
$(function(){
	...
	*/
	...
	$("#mail-flag").on("blur",function(){
		$.getJSON("../json/regist.json",function(response,status,xhr){
			if(status == "success"){
				var arr = response;
				obj = arr[0];
	...
	$("#item-check").click(function(){
		if($("#item-check").is(':checked')){//条款中的对钩是否选中
			flag6 = true;
		}else{
			flag6 = false;
		}
	...
	$("#phone-curReg").on("click",function(){
		if(flag1&&flag2&&flag3&&flag4&&flag6){//如果手机号 密码 短信验证码 条款都正确了 就可以注册
